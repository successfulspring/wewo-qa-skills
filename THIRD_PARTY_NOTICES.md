...
- `jsonschema`, `attrs`, `referencing`, `rpds-py`, and their supporting packages retain their respective upstream licenses.

Upstream package metadata and license texts are available from the corresponding Python package distributions used by the public build workflow. This repository's own source is licensed under MIT.
